...
class AnnotationTransform(object):
    ...
    def __call__(self, target):
        ...
        for obj in target.iter("object"):
            ...
            res = np.vstack((res, bndbox))  # [xmin, ymin, xmax, ymax, angle, label_ind]
            # img_id = target.find('filename').text[:-4]

        return res  # [[xmin, ymin, xmax, ymax, angle, label_ind], ... ]
...
class DOTAOBBDetection(Dataset):
    ...
    def pull_item(self, index):
        ...
        # img  image
        # target  [[xmin, ymin, xmax, ymax, angle, label_ind], ... ]
    ...
    def __getitem__(self, index):
        ...
        # img  预处理后的image
        # target  [[label_id, c_x, c_y, w, h, angle], ...]
        # img_info  原始图片大小(height, width)
        # index
