...
class YOLOXHead(nn.Module):
    ...
    def get_assignments(
        ...
        #print('yolo_head.py, line 467, fg_mask number is {}'.format(fg_mask.sum()))
        #print('yolo_head.py, line 468, is_in_boxes_and_center number is {}'.format(is_in_boxes_and_center.sum()))
